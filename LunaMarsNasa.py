...
def create_dataset(tr, window_size, step_size, scales, catalog_events, augment=False):
    """
    Crea ventanas de datos y extrae características y etiquetas para cada ventana.
    """
    data = []
    labels = []
    ...
    if augment:
        # Aquí puedes implementar técnicas de aumento de datos (data augmentation)
...
def augment_data(data):
    """
    Implementa una técnica básica de aumento de datos.
    """
    augmented_data = data.copy()
    # Por ejemplo, añade ruido gaussiano leve a los datos
    noise_factor = 0.005
...
def build_deep_model(input_shape):
    ...
    Aumentamos la complejidad de la red para mejorar la capacidad de generalización.
    """
...
def main():
    ...
    for planet, files in planet_datasets.items():
        ...
        data, labels = create_dataset(tr, window_size, step_size, scales, catalog_events, augment=True)
